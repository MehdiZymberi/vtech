...
export default function HeroBenefitListDesktop() {
  return (
    <div className="  space-y-8   h-fit  ">
      <div className="md:flex  w-full    flex-col h-full hidden space-y-8 md:space-y-2  ">
        <div className="flex flex-row items-center justify-start ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 -960 960 960"
            className="w-12 h-12 sm:w-14 sm:h-14  "
            fill="#0891B2 md:black"
          >
          ...
          <div className="md:ml-4 space-x-4 text-black flex-row flex">
            <span className=" font-semibold font-sourGummy text-xl"> Snel</span>
            <span className=" font-semibold font-sourGummy text-base hidden  md:block ">
              {" "}
        ...
        <div className="flex flex-row items-center justify-start ">
          ...
          <div className="md:ml-4 space-x-4 text-black flex-row flex">
            <span className=" font-semibold font-sourGummy text-xl">
              {" "}
              Krachtig
            </span>
            <span className="font-semibold font-sourGummy text-base hidden  md:block ">
